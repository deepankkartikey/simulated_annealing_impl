...
def main():
    ...
    max_iterations = 1000
    mutation_rate = 0.6
    print("\n\nHome: ", home, ", Iteration: ", max_iterations, ", Mutation Rate: ", mutation_rate)
    ...
    state1 = get_random_solution_from_population(distancesMatrix, home, city_indexes, 1000)
    # print("state1: ", state1)
    ...
    start = timer()
    [state, fitness] = random_restart(distancesMatrix, home, state1, max_iterations, mutation_rate)
    # print("state: ", state, ", fitness: ", fitness)
